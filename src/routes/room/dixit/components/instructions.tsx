    ...
    <Grow in={true}>
      <Stack spacing={2}>
        ...
        <Stack spacing={1}>
          ...
          <Typography variant='body1'>
            Người này sẽ dựa trên 6 thẻ bài trên tay mình, chọn 1 lá và nói ra 1 câu hoặc 1 từ cho
            tất cả người chơi còn lại nghe &#40;không cho họ nhìn thấy lá bài đã chọn&#41;.
          </Typography>
          <Typography variant='body1'>
            Sau đó mỗi người chơi chọn 1 lá bài từ 6 lá của riêng họ mà họ thấy là hợp với câu hoặc
            từ mà người kể chuyện đã nói.
          </Typography>
          <Typography variant='body1'>
