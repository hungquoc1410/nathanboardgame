  ...
  return (
    <Stack spacing={2}>
      ...
      <Stack spacing={1}>
        ...
        <Typography variant='body1'>Bắt đầu vòng mới cho đến khi có người đạt 25 điểm.</Typography>
      </Stack>
      <Stack spacing={1}>
        <Typography variant='h6' className='text-blue-500'>
      ...
      <Typography variant='body1'>
        Luật trên là để tham khảo. Hãy tạo luật mà nhóm bạn thấy phù hợp với nhóm nhất và tận hưởng
        trò chơi nhé!
      </Typography>
    </Stack>
  )
