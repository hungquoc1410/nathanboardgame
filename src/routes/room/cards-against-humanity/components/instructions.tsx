  ...
  return (
    <Stack spacing={2}>
      ...
      <Stack spacing={1}>
        ...
        <Typography variant='body1'>Trò chơi tiếp tục với một người mới làm giám khảo.</Typography>
        <Typography variant='body1'>
          Trò chơi kết thúc khi mọi người muốn dừng hoặc một người đạt được một số điểm nào đó được
          nhóm thống nhất trước.
        </Typography>
      </Stack>
    </Stack>
  )
